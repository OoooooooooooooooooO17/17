...
api_id = 410017
api_hash = 'e923090cb91a57407491296250911348'
sudo = db.get(profile + 'sudo')
# some asshole user-ids
# fullsudos = [407846832, 346735953, 411246190, 223097439, 353893098, 447297194, 488370269]
# url of shame
                    ...
                    if text and h.set(re.search('^addall (\d+)$', text)):
                        ...
                        if text and h.set(re.search('^start (@\S+)$', text)):
                            ...
                            if text and h.set(re.search('^botoff (\d+)$', text)):
                                ...
                                if text == 'help':
                                    send_msg(chat_id, '@RiderTab', m_id)
                                else:
                                    if text == 'help1':
                                                    ...
                                                    if text == 'help5':
                                                        ...
                                                        if text == 'share':
                                                            ...
                                                            if text == 'settings':
                                                                ...
                                                                send_msg(chat_id, '<i>Channel</i>: @RiderTab\n<i>Creator</i>: @sudoRider\n<i>Rider vr2.2</i>\n🔺🔻🔺🔻🔺🔻🔺🔻\n-- خواندن پیام ها➕تیک دوم : ' + ('✅' if db.get(profile + 'markread') else '❌') + '\n-- جوین خودکار : ' + ('❌' if db.get(profile + 'link_limit') else '✅') + '\n-- عضویت اجباری کانال : ' + ('✅' if db.get(profile + 'force_join') else '❌') + ' \n-- شناسه کانال عضویت اجباری کانال : ' + (db.get(profile + 'force_join') if db.get(profile + 'force_join') else 'خالی') + '\n-- فوروارد خودکار : ' + ('هر ' + str(db.get(profile + 'autofwd_time') or '') + ' ثانیه' if db.get(profile + 'autofwd_time') else '❌') + '\n-- پست های در صف فروارد : ' + str(db.scard(profile + 'autofwd_list')) + '\n-- مقصد فوروارد خودکار : ' + autofwd_type_t + '\n-- محدودیت تعداد اعضای گروه برای عضویت : ' + (str(db.get(profile + 'minjoincount') or '') if db.get(profile + 'minjoincount') else '❌'), m_id)
                                                            else:
                                                                if text == 'markread on':
                                                                    ...
                                                                    if text == 'markread off':
                                                                        ...
                                                                        if text == 'info':
                                                                            ...
                                                                            '''
                                                                            if last_version == Version:
                                                                                update = 'شما آخرین ورژن رایدر تبچی را نصب دارید ! ( ورژن ' + Version + ' )'
                                                                            else:
                                                                                update = 'آخرین نسخه  تبچی رایدر `' + last_version + '` و نسخه ی رایدر تبچی شما `' + Version + '` می باشد توصیه میکنیم برای استفاده از تمامی امکانات تبچی با استفاده از دستور `Update` تبچی رو با آخرین نسخه رایدر بروز نمایید !'
                                                                            '''
                                                                            send_msg(chat_id, '<b>  About Bot </b>\n\n▪️ شمارنده ربات : <code>' + str(profile) + '</code>\n▪️ نام ربات : <code>' + Bot['first_name'] + '</code>\n▪️ یوزر آیدی ربات : <code>' + str(Bot['id']) + '</code>\n▪️ شماره اکانت ربات : <code>+' + Bot['phone_number'] + '</code>\n🔺🔻🔺🔻🔺🔻🔺🔻\n<i>Stats is @RiderTab</i>\n🔺🔻🔺🔻🔺🔻🔺🔻\n<b>  Stats  </b>\n\n▪️ کانال ها : <code>' + str(db.scard(profile + 'pv_channels') + db.scard(profile + 'pub_channels')) + '</code>\n   ➖ کانال های عمومی : <code>' + str(db.scard(profile + 'pub_channels')) + '</code>\n   ➖ کانال های خصوصی : <code>' + str(db.scard(profile + 'pv_channels')) + '</code>\n▪️ سوپرگروه ها : <code>' + str(db.scard(profile + 'pv_supergroups') + db.scard(profile + 'pub_supergroups')) + '</code>\n   ➖ سوپرگروه های عمومی : <code>' + str(db.scard(profile + 'pub_supergroups')) + '</code>\n   ➖ سوپرگروه های خصوصی : <code>' + str(db.scard(profile + 'pv_supergroups')) + '</code>\n▪️ گروه ها : <code>' + str(db.scard(profile + 'groups')) + '</code>\n▪️ کاربران(پیوی ها) : <code>' + str(db.scard(profile + 'users')) + '</code>\n▪️ مخاطبین : <code>' + str(db.scard(profile + 'contacts')) + '</code>\n🔺🔻🔺🔻🔺🔻🔺🔻\n<b>  Info  </b>\n▪️ لینک های جوین شده : <code>' + str(db.scard(profile + 'saved_links')) + '</code>\n▪️ لینک های در صف جوین : <code>' + str(db.scard(profile + 'inwait_links')) + '</code>\n' + update + '\n🔺🔻🔺🔻🔺🔻🔺🔻\n<i>Channel</i>: @RiderTab\n<i>Creator</i>: @sudoRider\n<i>Rider vr2.2</i>', m_id, 'html')

                                                                        else:
                                                                            if text and h.set(re.search('^send (all|groups|supergroups|channels|users|contacts) (.+)$', text)):
                                                                                printw('Sending Pm to ' + h.get().group(1) + '+ ... !')
                                                                                send_msg(chat_id, '✅در انتظار فوروارد بنر به تمامی ' + h.get().group(1))
                                                                                tt = time()
                                                                                ...
                                                                                if text and h.set(re.search('^fwd (all|groups|supergroups|channels|users|contacts)$', text)) and m['reply_to_message_id'] != 0:
                                                                                    ...
                                                                                    send_msg(chat_id, '✅در انتظار فوروارد بنر به تمامی ' + chat_type_persian[h.get().group(1)])
                                                                                    tt = time()
                                                                                    type_list = list(db.smembers(profile + h.get().group(1))) + list(db.smembers(profile + 'pv_' + h.get().group(1))) + list(db.smembers(profile + 'pub_' + h.get().group(1)))
                                                                                    for chat in type_list:
                                                                                    ...
                                                                                    send_msg(chat_id, '✅پیام با موفقیت فوروارد شد!\n⏰ زمان ارسال: ' + timetostr(time() - tt))
                                                                                else:
                                                                                    if text and h.set(re.search('^send (\d+) (all|groups|supergroups|channels|users|contacts) (.+)$', text)):
                                                                                        ...
                                                                                        send_msg(chat_id, '📤در انتظار فورارد بنر به ' + str(count) + ' ' + chat_type_persian[h.get().group(2)])
                                                                                        for chat in type_list:
                                                                                                                    ...
                                                                                                                    if text == 'addcontacts off':
                                                                                                                        ...
                                                                                                                        if text == 'addcontacts null':
                                                                                                                            ...
                                                                                                                            if text and h.set(re.search('^addcontacts (.+)$', text)):
                                                                                                                                ...
                                                                                                                                send_msg(chat_id, '✅پیام افزودن مخاطب ذخیره و افزودن مخاطب با پیام فعال شد.\nپیام افزودن مخاطب به <code>"' + h.get().group(1) + '"</code> تنظیم شد !')
                                                                                                                            else:
                                                                                                                                if text == 'badnames list':
                                                                                                                                    badnames_text = ('\n').join((str(x) for x in db.smembers(profile + 'badnames')))
                                                                                                                                    send_msg(chat_id, '✅رایدر تبچی : @RiderTab\n✅سازنده : @sudoRider\nلیست کلمات سیاه : ' + ('خالی' if badnames_text == '' else badnames_text))
                                                                                                                                else:
                                                                                                                                    if text and h.set(re.search('^badnames \+ (.+)$', text)):
                                                                                                                                        badname = h.get().group(1).lower()
                                                                                                                                        if db.sismember(profile + 'badnames', badname):
                                                                                                                                            send_msg(chat_id, '💡کلمه ی مورد نظر در لیست سیاه وجود دارد .✅')
                                                                                                                                        else:
                                                                                                                                            db.sadd(profile + 'badnames', badname)
                                                                                                                                            send_msg(chat_id, '💡کلمه ی مورد نظر به لیست سیاه ➕ اضافه شد و ازین به بعد تبچی در گروه هایی که این کلمه در اسم آن وجود دارد عضو نمیشه.')
                                                                                                                                    else:
                                                                                                                                        if text and h.set(re.search('^badnames \- (.+)$', text)):
                                                                                                                                            badname = h.get().group(1).lower()
                                                                                                                                            if not db.sismember(profile + 'badnames', badname):
                                                                                                                                                send_msg(chat_id, '💡کلمه ی مورد نظر در لیست سیاه وجود ندارد.')
                                                                                                                                            else:
                                                                                                                                                db.srem(profile + 'badnames', badname)
                                                                                                                                                send_msg(chat_id, '💡کلمه ی مورد نظر از لیست سیاه پاک شد.')
                                                                                                                                        else:
                                                                                                                                            if text == 'setmincount off':
                                                                                                                                                db.delete(profile + 'minjoincount')
                                                                                                                                                send_msg(chat_id, 'محدودیت 👥 اعضا 👥 برای عضو شدن برداشته شد.')
                                                                                                                                            else:
                                                                                                                                                if text and h.set(re.search('^setmincount (\d+)$', text)):
                                                                                                                                                    db.set(profile + 'minjoincount', int(h.get().group(1)))
                                                                                                                                                    send_msg(chat_id, '✅ رایدر تبچی در گروه هایی که اعضای آن کمتر از "' + h.get().group(1) + '" است , عضو نمیشه 😄')
                                                                                                                                                else:
                                                                                                                                                    if text == 'autofwd list':
                                                                                                                                                        send_msg(chat_id, '↙️ اینم از بنر های که توی لیست فوروارد خودکار هست ↗️')
                                                                                                                                                        ...
                                                                                                                                                        if text == 'autofwd +' and m['reply_to_message_id'] != 0:
                                                                                                                                                            ...
                                                                                                                                                            if not db.sismember(profile + 'autofwd_list', post_data):
                                                                                                                                                                ...
                                                                                                                                                                send_msg(chat_id, 'بنر مورد نظر شما به لیست ➕ فوروارد ➕ اضافه شد.', m_id)
                                                                                                                                                            else:
                                                                                                                                                                send_msg(chat_id, 'بنر مورد نظر شما در لیست 📌 فروارد 📌 موجود بود.', m_id)
                                                                                                                                                        else:
                                                                                                                                                            if text == 'autofwd -' and m['reply_to_message_id'] != 0:
                                                                                                                                                                post_data = str(m['reply_to_message_id']) + ':' + str(m['chat_id'])
                                                                                                                                                                if db.sismember(profile + 'autofwd_list', post_data):
                                                                                                                                                                    db.srem(profile + 'autofwd_list', post_data)
                                                                                                                                                                    send_msg(chat_id, 'بنر مورد نظر شما از لیست 🗃 فوروارد 🗃 حذف شد.', m_id)
                                                                                                                                                                else:
                                                                                                                                                                    send_msg(chat_id, 'بنر مورد نظر شما در لیست 📌 فروارد 📌 وجود ندارد.', m_id)
                                                                                                                                                            else:
                                                                                                                                                                if text == 'autofwd clean':
                                                                                                                                                                    db.delete(profile + 'autofwd_list')
                                                                                                                                                                    send_msg(chat_id, '📂لیست بنر های در حال فوروارد خودکار پاک شد.', m_id)
                                                                                                                                                                else:
                                                                                                                                                                    if text == 'autofwd off':
                                                                                                                                                                        db.delete(profile + 'autofwd_time')
                                                                                                                                                                        db.set(profile + 'autofwd_limit', True)
                                                                                                                                                                        send_msg(chat_id, 'فوروارد خودکار 📍 غیرفعال 📍 شد.', m_id)
                                                                                                                                                                    else:
                                                                                                                                                                        if text and h.set(re.search('^autofwd (\d+)$', text)):
                                                                                                                                                                            ...
                                                                                                                                                                            send_msg(chat_id, 'زمان ارسال بین هر بنر به ⏰' + str(fwdtime) + '⏰ ثانیه تغییر یافت.', m_id)
                                                                                                                                                                        else:
                                                                                                                                                                            if text and h.set(re.search('^autofwd (.+)$', text)):
                                                                                                                                                                                ...
                                                                                                                                                                                if autofwd_type != '':
                                                                                                                                                                                    ...
                                                                                                                                                                                    send_msg(chat_id, 'بنر های لیست فوروارد خودکار به ♻️' + str(chat_type_persian[h.get().group(1)]) + '♻️ارسال خواهد شد.', m_id)
                                                                                                                                                                            else:
                                                                                                                                                                                if text == 'forcejoin off':
                                                                                                                                                                                    db.delete(profile + 'force_join')
                                                                                                                                                                                    send_msg(chat_id, '📍جوین اجباری در کانال برای کاربران پیوی لغو شد.')
                                                                                                                                                                                else:
                            ...
                            if event['authorization_state']['@type'] == 'authorizationStateWaitCode':
                                ...
                                if event['authorization_state']['@type'] == 'authorizationStateWaitPassword':
                                    ...
                                    if event['authorization_state']['@type'] == 'authorizationStateReady':
                                        ...
                                        '''
                                        version = db.get(profile + 'Version') or '2.2'
                                        if Version != version:
                                            send_msg(sudo, 'رایدر تبچی با موفقیت به نسخه <code>' + Version + '</code> بروز شد .\n💡تغییرات آخرین نسخه :  \n💡<pre>' + requests.get(host_url + '/getDesc.php?v=' + Version).content + '</pre>', 0, 'html')'
                                        ...
                                        if last_version == Version:
                                            ...
                                            update = 'آخرین نسخه  تبچی رایدر `' + last_version + '` و نسخه ی رایدر تبچی شما `' + Version + '` می باشد توصیه میکنیم برای استفاده از تمامی امکانات تبچی با استفاده از دستور `Update` تبچی رو با آخرین نسخه رایدر بروز نمایید !'
                                        '''
                                        send_msg(sudo, '😍تبچی شماره <code>' + str(profile) + '</code> با موفقیت لانچ شد.\n' + update, 0, 'markdown')
